...
| 📋 **ReportMagic Macros** | [instructions/reportmagic-macros.md](instructions/reportmagic-macros.md) | Creating rmscript test files for ReportMagic Core macros and 'core-like' macros |
