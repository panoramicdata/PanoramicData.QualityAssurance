 ...
 * 1. Log in manually with Regular User credentials
 * 2. Click "Resume" in the Playwright Inspector
 * 
 * The authentication state will be saved to .auth/regular-user.json
 * 
 * Usage: npx playwright test auth.setup.regular-user --headed --project=firefox
 */
...
setup('authenticate as Regular User', async ({ page }) => {
  ...
  console.log('');
  console.log('⚠️  IMPORTANT: Log in with REGULAR USER credentials');
  console.log('');
  console.log('This should be a non-admin user account.');
  ...
  console.log('🔐 Please log in manually with Regular User account');
  ...
  console.log('\n=================================================================');
  console.log('✅ Regular User authentication state saved successfully!');
