...
/**
 * Docs (DocMagic) Home Page Tests
 * Tests the documentation portal
 */
...
test.describe('Docs Home Page', () => {
  test('should load correctly', async ({ page }) => {
    ...
    // 2. Verify page has correct title (Docs site uses 'Getting Started' as home page title)
    await expect(page, 'Page should have correct title').toHaveTitle(/Docs|DocMagic|Magic Suite|Documentation|Getting Started/i);
