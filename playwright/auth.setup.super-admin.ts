 ...
 * 1. Log in manually with Super Admin credentials
 * 2. Click "Resume" in the Playwright Inspector
 * 
 * The authentication state will be saved to .auth/super-admin.json
 * 
 * Usage: npx playwright test auth.setup.super-admin --headed --project=firefox
 */
...
setup('authenticate as Super Admin', async ({ page }) => {
  ...
  console.log('\n=================================================================');
  console.log('SUPER ADMIN LOGIN SETUP');
  console.log('=================================================================');
  console.log(`Environment: ${env}`);
  console.log(`Login URL: ${loginUrl}`);
  console.log('');
  console.log('⚠️  IMPORTANT: Log in with SUPER ADMIN credentials');
  console.log('');
  console.log('This should be a user with super admin permissions.');
  ...
  console.log('🔐 Please log in manually with Super Admin account');
  ...
  console.log('\n=================================================================');
  console.log('✅ Super Admin authentication state saved successfully!');
